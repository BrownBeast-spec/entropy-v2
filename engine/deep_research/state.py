...
# from langgraph.graph import MessagesState # If user doesn't have langgraph.graph, this might fail unless they have it. Example used it.
...
class SearchResult(BaseModel):
    ...
    query: str = Field(description="The original default")
