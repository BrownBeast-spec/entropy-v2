...
export function registerOpenTargetsTools(server) {
    // ─── 1. Validate Target ─────────────────────────────────────────────
    server.tool("validate_target", "Validates a target by resolving its gene symbol to an Ensembl ID and fetching associated diseases from Open Targets.", {
    ...
    // ─── 2. Get Drug Info ───────────────────────────────────────────────
    server.tool("get_drug_info", "Get drug information by ChEMBL ID including name, description, clinical phase, and linked diseases.", {
    ...
    // ─── 3. Get Disease Info ────────────────────────────────────────────
    server.tool("get_disease_info", "Get disease information by EFO ID including name, description, and therapeutic areas.", {
