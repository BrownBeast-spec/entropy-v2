...
var PgDB = class extends MastraBase {
  ...
  async clearTable({ tableName }) {
    try {
      ...
      const tableExists = await this.client.oneOrNone(
        `SELECT EXISTS (
...
var MemoryPG = class _MemoryPG extends MemoryStorage {
  ...
  constructor(config) {
    ...
    this.#schema = schemaName || "public";
    this.#skipDefaultIndexes = skipDefaultIndexes;
    this.#indexes = indexes?.filter((idx) => _MemoryPG.MANAGED_TABLES.includes(idx.table));
  }
  async init() {
...
var ScoresPG = class _ScoresPG extends ScoresStorage {
  #db;
  #schema;
  #skipDefaultIndexes;
  #indexes;
  ...
  constructor(config) {
    ...
    this.#schema = schemaName || "public";
    this.#skipDefaultIndexes = skipDefaultIndexes;
    this.#indexes = indexes?.filter((idx) => _ScoresPG.MANAGED_TABLES.includes(idx.table));
  }
  async init() {
